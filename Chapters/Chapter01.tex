...
The main driver for the construction of the LHC and the deployment of the CMS experiment was certainly the Higgs boson. 
...
\begin{figure}
    ...
    \caption[Signal strength modifiers]{Summary plot showing the signal measured signal strength per
...
Here we briefly mention the \emph{Vector Boson Fusion} production channel, as well as the decay of the Higgs boson in two muons, an interesting decay channel employed for a comparison of the results of this thesis.
...
WH and ZH production, and production in association with a $\tau \overline{\tau}$  or b$\overline{\text{b}}$ pair.
...
terized by two separated high-rapidity quarks in the final state, detectable as high rapidity
