...
\begin{figure}
    \myfloatalign
    \subfloat[]
    {\includegraphics[width=\linewidth]{gfx/ch6/DY2Jets_vs_HMM_powheg_Rpt___PreSel_log_normalized.pdf}}\\
    \subfloat[]
...
\begin{figure}
    ...
    \caption[Angular distributions]{Background processes, such as (a), (b), and (c) are always decreasing, while signal processes ((d) and (e)) are increasing in the 0,3 range. }\label{fig:DNNout}
\end{figure}
